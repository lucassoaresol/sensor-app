        ...
        {yPData.map((el, index) => {
          return (
            <Fragment key={index}>
              <StyledText
                x={
                  Number(xAxisScale(xPData[index])) +
                  width / yNData.length / 2.25
                }
                y={yAxisScale(el)}
                textAnchor="middle"
      ...
      <>
        ...
        {yNData.map((el, index) => (
          <Fragment key={index}>
            <StyledText
              x={
                Number(xAxisScale(xNData[index])) + width / yNData.length / 2.5
              }
              y={yAxisScale(el)}
              textAnchor="end"
              dominantBaseline="text-after-edge"
